...
<body ng-controller="MainController" ng-cloak style="background:#292d34;color:#e3e3e3;">
	<nav class="navbar navbar-default navbar-inverse">
		...
		<a class="navbar-brand" href="/">4 Суши</a>
	...
	<div id="divContainer">
		...
		$string = file_get_contents("../../../server/data4s.json");
		// if ($string === false) {
		//     // deal with error...
		// }
		...
		if($_COOKIE['userType']==4 || $_COOKIE['userID']==1  || $_COOKIE['userType']==5 || $_COOKIE['userType']==6){
			...
			// echo $_COOKIE['userID'];
			$query ="
			select distinct stores.id as storeID, stores.bakery as bakery, stores.name as storeName, stores.venue as venue
			from stores4s as stores, userStores, users
